                                ...
                                <?php
                                    ...
                                    while($row = pg_fetch_array($wyniki)){
                                      if($row['status'] == "W użyciu"){
                                        echo "<tr><input type='hidden' disabled name='id_sprzet' value='".$row['id_sprzet']."'><td>" . $row['model'] . "</td><td style='cursor:pointer;' onclick='detale(this)'>" . $row['nr_seryjny'] . "</td><td>" . $row['rodzaj_sprzetu'] . "</td><td>" . $row['dodatkowy_opis'] . "</td><td>" . $row['nazwa_uzytkownika'] . "</td><td>" . $row['stanowisko'] . "</td><td style='color:#00FF04;'>" . $row['status'] . "</td><td class='data'>" . $row['termin'] . "</td></tr>"; 
                                        }
                                      elseif($row['status'] == ""){
                                        echo "<tr><input type='hidden' disabled name='id_sprzet' value='".$row['id_sprzet']."'><td>" . $row['model'] . "</td><td style='cursor:pointer;' onclick='detale(this)'>" . $row['nr_seryjny'] . "</td><td>" . $row['rodzaj_sprzetu'] . "</td><td>" . $row['dodatkowy_opis'] . "</td><td>" . $row['nazwa_uzytkownika'] . "</td><td>" . $row['stanowisko'] . "</td><td style='color:#ffff1a;'>Brak Statusu". "</td><td class='data'>" . $row['termin'] . "</td></tr>"; 
                                      }
                                      else{
                                        echo "<tr><input type='hidden' disabled name='id_sprzet' value='".$row['id_sprzet']."'><td>" . $row['model'] . "</td><td style='cursor:pointer;' onclick='detale(this)'>" . $row['nr_seryjny'] . "</td><td>" . $row['rodzaj_sprzetu'] . "</td><td>" . $row['dodatkowy_opis'] . "</td><td>" . $row['nazwa_uzytkownika']. "</td><td>" . $row['stanowisko'] . "</td><td style='color:#FF2F2F;'>" . $row['status'] . "</td><td class='data'>" . $row['termin'] . "</td></tr>"; 
                                      }
                                    }
