        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Edytuj sprzęt</h1>

                    <form action="./edytuj_sprzet.php" method="POST" autocomplete="off">
                        ...
                        <select class="form-control" name="rodzaj" id="rodzaj">
                            ...
                            <option value="monitor">DRUKARKA</option>
                        </select>
                        </br>
                        <input class="form-control" type="text" id="marka" placeholder="MARKA">
                        </br>
                    ...
                    <div id="alert_success" data-delay="3000" class="toast">
                        <div class="alert alert-success hide" role="alert" aria-live="assertive" aria-atomic="true">
                            Pomyślnie zaaktualizowano sprzęt!
                        </div>
                    </div>
