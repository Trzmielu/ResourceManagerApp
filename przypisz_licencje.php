            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Przypisz licencje</h1>
                    </div>

                    <form action="./przypisz_licencje.php" method="POST" autocomplete="off">
                        <select class="form-control" name="licencja" id="licencja">
                                ...
                                <?php
                                    ...
                                    $sql = "SELECT DISTINCT ON (nazwa) nazwa, id, data_waznosci FROM licencja WHERE sprzet_id IS NULL and data_waznosci > NOW() ORDER BY nazwa";
