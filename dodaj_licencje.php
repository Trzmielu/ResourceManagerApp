            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Dodaj licencje</h1>
                    </div>

                    <form action="./dodaj_licencje.php" method="POST" autocomplete="off">
                        <input  class="form-control" type="text" id="nazwa_licencji" name="nazwa_licencji"
                        placeholder="NAZWA LICENCJI">
                        </br>
                        <input  class="form-control" type="number" id="ilosc_licencji" name="ilosc_licencji" placeholder="ILOŚĆ">
                        </br>
                        DATA WYGAŚNIĘCIA
                        </br>
