        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Usuń licencje</h1>

                    <form action="./usun_licencje.php" method="POST" autocomplete="off">
...
<?php
            if(isset($_POST['id'])){
                ...
                $sql = "DELETE FROM `licencja` WHERE id = '$_POST[id]'";
