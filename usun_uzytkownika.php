        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Usuń użytkownika</h1>

                    <form action="./usun_uzytkownika.php" method="POST" autocomplete="off">
                        ...
                        <input class="form-control" data-delay="3000" type="submit" value="USUŃ">
                    </form>
                    <div id="alert_success" class="toast">
