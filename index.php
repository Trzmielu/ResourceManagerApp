                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h1 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                    if(isset($_GET['jaka_licencja']) && $_GET['jaka_licencja'] != 'Wszystkie'){
                                                        wyswietl("SELECT COUNT(*) AS wynik FROM licencja WHERE data_waznosci < NOW() and nazwa = '" . $_GET['jaka_licencja']."'");
                                                    }
                                                    else{
                                                        wyswietl("SELECT COUNT(*) AS wynik FROM licencja WHERE data_waznosci < NOW()");
                                                    }
                                                ?>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h1 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                    if(isset($_GET['jaka_licencja']) && $_GET['jaka_licencja'] != 'Wszystkie'){
                                                        wyswietl("SELECT COUNT(*) AS wynik FROM licencja WHERE data_waznosci > NOW() and data_waznosci < (NOW()+ INTERVAL '6 months') and nazwa = '" . $_GET['jaka_licencja']."'");
                                                    }
                                                    else{
                                                        wyswietl("SELECT COUNT(*) AS wynik FROM licencja WHERE data_waznosci > NOW() and data_waznosci < (NOW()+ INTERVAL '6 months')");
                                                    }
                                                ?>
                                            </div>
                                        </div>
